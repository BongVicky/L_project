...
var GcalEventSource = /** @class */ (function (_super) {
    ...
    GcalEventSource.prototype.buildRequestParams = function (start, end, timezone) {
        ...
        // Since the tasks's timezone offset isn't always known, request the date in UTC and pad it by a day on each
    ...
    GcalEventSource.API_BASE = 'https://www.googleapis.com/tasks/v3/calendars';
...
function parseGoogleCalendarId(url) {
    ...
    // will match calendars like "asdf1234@tasks.google.com" in addition to person email calendars.
